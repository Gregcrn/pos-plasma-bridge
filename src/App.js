...
const App = () => {
    ...
    content = (
      <div>
        ...
        >
          ...
          >
            <button
              className="btn btn-secondary mx-4 mt-4"
  ...
  return (
    <div className="vh-100 bg-dark">
      ...
      <div>
        <div className="container-fluid col-xs-1 text-center bg-dark h-100 mx-auto">
          <div>
            <select className="custom-select w-50 mx-auto mt-3"
          ...
          <div>
            <select className="custom-select w-50 mx-auto mt-3" onChange={(e) => setSelectedToken({ label: e.target.value })}>
              {tokenTypes.map((item) => (
                <option key={item.value} value={item.value}>
                  {item.label}
                </option>
